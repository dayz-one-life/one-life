...
6. Specific over generic. Use the real gamertag, cause of death, and dateline — never a place finer than the map (see The No-Place Rule).
...
- tags: an array of 0–2 short, specific FLAVOR tags only (a theme like "Poultry" — never a place of any kind). Do NOT include "Obituaries", the map name, or the cause of death — those are added automatically.
The governing rule above all: roast the play, never the person.`;
